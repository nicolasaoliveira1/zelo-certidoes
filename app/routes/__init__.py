...
from app.automation import SITES_CERTIDOES, pdf
...
# Importados pelo efeito colateral de registrar rotas no blueprint 'main' e, no
# caso de lotes, os fluxos do agendador. bp ja esta definido acima.
from app.routes import lotes  # noqa: E402,F401

# re-export p/ compat de testes que acessam app.routes._registrar_fluxos_agendador
_registrar_fluxos_agendador = lotes._registrar_fluxos_agendador  # noqa: E402
